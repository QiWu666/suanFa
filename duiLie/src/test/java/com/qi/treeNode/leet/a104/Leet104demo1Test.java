...
import com.qi.treeNode.leetCode.a104.Leet104demo1;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

public class Leet104demo1Test {

    @Test
    public void testMaxDepth() {
        Leet104demo1 leet104demo1 = new Leet104demo1();

        // Test case 1: node is null
        TreeNode node1 = null;
        int result1 = leet104demo1.maxDepth(node1);
        Assertions.assertEquals(0, result1);

        // Test case 2: node has no children
        TreeNode node2 = new TreeNode(1);
        int result2 = leet104demo1.maxDepth(node2);
        ...
        int result3 = leet104demo1.maxDepth(node3);
        ...
        int result4 = leet104demo1.maxDepth(node4);
        ...
        int result5 = leet104demo1.maxDepth(node5);
        ...
        int result6 = leet104demo1.maxDepth(node6);
